...
// use pallet_contracts::DefaultContractAccessWeight;   // no implementation in the latest version
...
// constants required by the Contracts pallet
...
impl_runtime_apis! {
	impl pallet_contracts::ContractsApi<Block, AccountId, Balance, BlockNumber, Hash> for Runtime {
		fn call(
			...
			Contracts::bare_call(origin, dest, value, gas_limit.unwrap(), storage_deposit_limit, input_data, CONTRACTS_DEBUG_OUTPUT)
		}
		...
		fn instantiate(
			...
			Contracts::bare_instantiate(origin, value, gas_limit.unwrap(), storage_deposit_limit, code, data, salt, CONTRACTS_DEBUG_OUTPUT)
		}
